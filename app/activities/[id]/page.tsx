          ...
          {membershipLocked ? (
            ...
            >
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                ...
                >
                  Evento de comunidade privada / Private community event
                </span>
              </div>
              ...
              >
                Este evento pertence a uma comunidade privada. Entre na comunidade para acessar todos os detalhes, participantes, mapa e chat. / This event belongs to a private community. Join the community to view the full details, attendees, map and chat.
              </div>

              {lockedCommunityId && (
                <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                  <Link
                    href={`/groups/${lockedCommunityId}`}
                    style={{
                      fontSize: 12,
                      padding: "10px 12px",
                      borderRadius: 6,

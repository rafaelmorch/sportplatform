...
const COPY = {
  pt: {
    ...
    subtitle:
      "Responda este breve questionário antes de acessar o Performance AI Coach.",
    ...
    membershipMissing: "A assinatura ativa do Performance AI não foi encontrada.",
    unexpected: "Ocorreu um erro inesperado. Tente novamente.",
  },
  en: {
    title: "Health & Safety",
    subtitle:
      "Please complete this short questionnaire before accessing the Performance AI Coach.",
    ...
    membershipMissing: "An active Performance AI subscription could not be found.",
  ...
  useEffect(() => {
    ...
    async function loadPage() {
      ...
      if (
        ...
        router.replace("/performance-ai/subscribe");
        return;
      }

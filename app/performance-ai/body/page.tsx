...
import WeightHistoryCard from "@/components/performance/WeightHistoryCard";
import TimelineCard from "@/components/performance/TimelineCard";
    ...
    <main style={pageStyle}>
      ...
      <section style={pageContainerStyle}>
        ...
        {showBioForm && (
          <section style={bioFormPanelStyle}>
            ...
            <DocumentUploader
              ...
              error={bioFileError}
              dragging={isDraggingBioFile}
              analyzing={analyzingBioDocument}
              onChange={handleBioFileChange}
              onDrop={handleBioFileDrop}
              onDragStateChange={setIsDraggingBioFile}
              onRemove={handleRemoveBioFile}
              onAnalyze={handleAnalyzeBioDocument}
              styles={{
                area: bioUploadAreaStyle,
                input: hiddenFileInputStyle,
                selectButton: bioSelectFileButtonStyle,
                uploadLabel: bioUploadLabelStyle,
                uploadTitle: bioUploadTitleStyle,
                uploadDescription: bioUploadDescriptionStyle,
                uploadFormats: bioUploadFormatsStyle,
                selectedFile: bioSelectedFileStyle,
                selectedFileHeader: bioSelectedFileHeaderStyle,
                selectedFileInfo: bioSelectedFileInfoStyle,
                fileTypeBadge: bioFileTypeBadgeStyle,
                fileTextArea: bioFileTextAreaStyle,
                fileName: bioFileNameStyle,
                fileMetadata: bioFileMetadataStyle,
                removeFileButton: bioRemoveFileButtonStyle,
                fileReady: bioFileReadyStyle,
                analyzeButton: bioAnalyzeButtonStyle,
                nextStepText: bioNextStepTextStyle,
                error: bioUploadErrorStyle,
              }}
            />
            <AiReviewPanel
              visible={bioAnalysisReady}
              assessmentDate={bioAssessmentDate}
              weightKg={bioWeightKg}
              bodyFat={bioBodyFat}
              muscleMass={bioMuscleMass}
              waterPercent={bioWaterPercent}
              visceralFat={bioVisceralFat}
              bmr={bioBmr}
              summary={bioAnalysisSummary}
              performanceInsights={bioPerformanceInsights}
              nutritionInsights={bioNutritionInsights}
              attentionPoints={bioAttentionPoints}
              disclaimer={bioDisclaimer}
              saving={savingBio}
              ...
              styles={{
                panel: bioReviewPanelStyle,
                eyebrow: bioReviewEyebrowStyle,
                header: bioReviewHeaderStyle,
                title: bioReviewTitleStyle,
                description: bioReviewDescriptionStyle,
                status: bioReviewStatusStyle,
                metrics: bioReviewMetricsStyle,
                metric: bioReviewMetricStyle,
                metricLabel: bioReviewMetricLabelStyle,
                metricValue: bioReviewMetricValueStyle,
                textSection: bioReviewTextSectionStyle,
                sectionLabel: bioReviewSectionLabelStyle,
                bodyText: bioReviewBodyTextStyle,
                list: bioReviewListStyle,
                listItem: bioReviewListItemStyle,
                bullet: bioReviewBulletStyle,
                attentionSection: bioAttentionSectionStyle,
                attentionLabel: bioAttentionLabelStyle,
                attentionBullet: bioAttentionBulletStyle,
                disclaimer: bioDisclaimerStyle,
                confirmButton: bioConfirmButtonStyle,
              }}
            />
            ...
            <BodyMetricsForm
              ...
              notes={bioNotes}
              saving={savingBio}
              onAssessmentDateChange={setBioAssessmentDate}
              onWeightKgChange={setBioWeightKg}
              onBodyFatChange={setBioBodyFat}
              onMuscleMassChange={setBioMuscleMass}
              onVisceralFatChange={setBioVisceralFat}
              onWaterPercentChange={setBioWaterPercent}
              onBmrChange={setBioBmr}
              onNotesChange={setBioNotes}
              onSubmit={handleSaveBioimpedance}
              styles={{
                form: bioFormStyle,
                field: weightFieldStyle,
                label: weightInputLabelStyle,
                input: bioInputStyle,
                inputWrapper: weightInputWrapperStyle,
                inputWithUnit: weightInputStyle,
                unit: weightUnitStyle,
                bmrUnit: bioBmrUnitStyle,
                notesField: bioNotesFieldStyle,
                textarea: bioTextareaStyle,
                saveArea: bioSaveAreaStyle,
                saveButton: saveWeightButtonStyle,
              }}
            />
          </section>
        )}
        ...
        <SummaryCards
          cards={summaryCards}
          styles={{
            grid: summaryGridStyle,
            card: summaryCardStyle,
            label: cardLabelStyle,
            value: cardValueStyle,
            detail: cardDetailStyle,
          }}
        />
        <WeightHistoryCard
          ...
          styles={{
            ...
            eyebrow: sectionEyebrowStyle,
            title: sectionTitleStyle,
            description: sectionDescriptionStyle,
            variationBadge: variationBadgeStyle,
            emptyChart: emptyChartStyle,
            chartWrapper: chartWrapperStyle,
            chart: chartStyle,
            chartDates: chartDatesStyle,
          }}
        />
        <section style={contentGridStyle}>
          <TimelineCard
            ...
            styles={{
              panel: sectionPanelStyle,
              header: timelineHeaderStyle,
              eyebrow: sectionEyebrowStyle,
              title: sectionTitleStyle,
              description: sectionDescriptionStyle,
              count: timelineCountStyle,
              emptyText: emptyTextStyle,
              timeline: timelineStyle,
              item: timelineItemStyle,
              rail: timelineRailStyle,
              dot: timelineDotStyle,
              line: timelineLineStyle,
              content: timelineContentStyle,
              topRow: timelineTopRowStyle,
              date: timelineDateStyle,
              time: timelineTimeStyle,
              weight: timelineWeightStyle,
              unit: timelineUnitStyle,
              bottomRow: timelineBottomRowStyle,
              change: timelineChangeStyle,
              direction: timelineDirectionStyle,
            }}
          />
          <LatestBioCard
            latestBio={latestBio}
            metrics={latestBioMetrics}
            formatDate={formatDate}
            styles={{
              panel: sectionPanelStyle,
              header: sectionHeaderStyle,
              ...
              title: sectionTitleStyle,
              description: sectionDescriptionStyle,
              currentBadge: currentBadgeStyle,
              emptyText: emptyTextStyle,
              metricsGrid: bioMetricsGridStyle,
              metricCard: bioMetricCardStyle,
              metricLabel: bioMetricLabelStyle,
              metricValue: bioMetricValueStyle,
              notes: notesStyle,
            }}
          />
        </section>
        ...
        <PreviousBioHistory
          ...
          styles={{
            ...
            eyebrow: sectionEyebrowStyle,
            title: sectionTitleStyle,
            grid: previousBioGridStyle,
            card: previousBioCardStyle,
            date: previousBioDateStyle,
            values: previousBioValuesStyle,
            metric: previousMetricStyle,
            metricLabel: previousMetricLabelStyle,
            metricValue: previousMetricValueStyle,
          }}
        />

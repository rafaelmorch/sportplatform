...
export default function PerformanceAIPage() {
  ...
  const openQuickPage = (href: string) => {
    setQuickMenuOpen(false);
    router.push(href);
  };
  if (loading) {
...
const quickMenuItemStyle: React.CSSProperties = {
  ...
  borderRadius: 999,
  background:
    "linear-gradient(145deg, rgba(31,31,34,0.98) 0%, rgba(12,12,13,0.98) 100%)",
  boxShadow:
    "0 12px 30px rgba(0,0,0,0.46), inset 0 1px 0 rgba(255,255,255,0.06)",
  color: "#f4f4f5",
  padding: "10px 18px",
  fontFamily: "inherit",
  fontSize: 13,

        ...
        >
          ...
          <div style={{ display: "grid", gap: 12 }}>
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <select
                value={runnerLevel}
                onChange={(e) => setRunnerLevel(e.target.value)}
                style={{
                  width: "100%",
                  padding: 12,
                  borderRadius: 12,
              ...
              >
                <option value="yellow">Yellow Shirt</option>
                <option value="orange">Orange Shirt</option>
                <option value="purple">Purple Shirt</option>
